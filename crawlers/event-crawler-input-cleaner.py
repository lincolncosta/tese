...
def processGames(game):
    ...
    if isinstance(game, str):
        ...
        with open('../data/crawler/crawler-input-2023.csv', mode='a', newline="", encoding='utf-8') as datasetSecondary2022:
...
processed_df = pd.read_csv("../data/crawler/crawler-input-2023.csv")
...
with open('../data/crawler/crawler-input-2023.csv', mode='a', encoding='utf-8') as dataset:
